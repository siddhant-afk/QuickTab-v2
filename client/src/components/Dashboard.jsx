...
function Dashboard() {
    ...
    return (
        <section className="dashboard">
            <Box marginTop={6} bg='white' w='1250px'  color='black' border='1px' borderColor='#ede6e6' borderTopRadius='md'>
         <Box bg='#F8F9FA'  >
         ...
         <Grid templateColumns='20% 80%' p={0} h='80px' w='100%'>
          ...
          <GridItem   paddingTop={1} color='tomato' paddingLeft={5}>
            ...
            <Grid templateColumns='auto auto auto auto' color='black'>
              ...
              <GridItem>₹3,77,562.99 <br /> <span className="text-gray-500 text-sm">Above 45 Days</span></GridItem>
            </Grid>
